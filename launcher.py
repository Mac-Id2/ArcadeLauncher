...
Inklusive nativem OS-AFK-Watchdog und Mac/Linux-Display-Fix.
"""
...
def get_system_idle_time():
    ...
    if os_name == "Windows":
        ...
        try:
            # Versuch 1: xprintidle (Standard bei vielen Desktop-Linux-Systemen)
        ...
        try:
            # Versuch 2: Fallback über /dev/input (braucht evtl. Rechte auf die input-Gruppe)
            idle_times = []
